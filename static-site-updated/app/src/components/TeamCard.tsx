            ...
            <div className="flex justify-center space-x-3">
              ...
              {media.portfolio && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="p-2 rounded-full bg-gray-50 hover:bg-yellow-500 hover:text-white text-gray-600 transition-all duration-300 transform hover:scale-110" 
                  onClick={e => e.stopPropagation()}
                >
                  <FaGlobe size={18} />
                </a>
                  ...
                  <div className="flex gap-3">
                    ...
                    {media.portfolio && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="w-10 h-10 flex items-center justify-center rounded-full bg-white hover:bg-yellow-500 text-gray-600 hover:text-white transition-all duration-300 shadow-md hover:shadow-lg hover:scale-110"
                      >
                        <FaGlobe size={18} />
                      </a>
                    )}
